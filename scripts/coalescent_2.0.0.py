...
def coalesce(N,nodes,i,genN,gens,coalT):
    ...
    print("Population at time",genN[int(-coalT)])

    coalT += Twaitn
    print("time coalesced:",coalT,len(genN))
...
if __name__ == '__main__':
    ...
    for j in range(2,14):
        gens+=Nmax/nchoose2(j)    
    print("max generations:",gens) #silumation length 
    
    genN = [0] * int(gens)
    for j in range(int(gens)):
